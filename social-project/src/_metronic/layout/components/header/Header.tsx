...
const Header = ({
  ...
  return (
    <div className={clsx(isMobile ?
      'menu menu-rounded menu-row menu-lg-row my-2 my-lg-0 align-items-center fw-semibold px-lg-0' :
      'menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-center fw-semibold px-2 px-lg-0'
    )}>
      <MenuInner
        isMobile={isMobile}
      />
