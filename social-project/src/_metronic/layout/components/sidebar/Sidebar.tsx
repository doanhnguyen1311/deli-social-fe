  ...
  return (
    <>
      <div
        ref={sidebarRef}
        id='kt_app_sidebar'
        className={clsx('app-sidebar min-w-95px mw-95px bg-white', config.app?.sidebar?.default?.class)}
      >
        <div
          className='position-fixed top-0 start-0 h-100 d-flex flex-column min-w-95px mw-95px p-16px'
          style={{
            zIndex: 99,
          }}
        >
