...
const SidebarLogo = (props: PropsType) => {
  ...
  return (
    <div className='app-sidebar-logo h-45px' id='kt_app_sidebar_logo'>
      <Link
        aria-label={'link'}
        to={
      ...
      >
        {config.layoutType === 'dark-sidebar' ? (
          <img
            alt='Logo'
            src={Logo}
            className='h-100 w-40px app-sidebar-logo-default'
          />
        ) : (
          <>
            <img
              alt='Logo'
              src={Logo}
              className='h-100 w-40px app-sidebar-logo-default theme-light-show'
            />
            <img
              alt='Logo'
              src={Logo}
              className='h-100 w-40px app-sidebar-logo-default theme-dark-show'
            />
          </>
        )}
        ...
        <img
          alt='Logo'
          src={Logo}
          className='h-100 w-40px app-sidebar-logo-minimize'
        />
      </Link>
