...
class DrawerComponent {
  ...
  private _handlers = () => {
    ...
    if (togglers !== null && togglers.length > 0 && typeof window !== 'undefined') {
      DOMEventHandlerUtil.on(window.document.body, togglers, 'click', (e: Event) => {
        e.preventDefault()
        this.toggleElement = window.document.getElementById(togglers)
        this._toggle()
      })
    }

    if (closers !== null && closers.length > 0 && typeof window !== 'undefined') {
      DOMEventHandlerUtil.on(window.document.body, closers, 'click', (e: Event) => {
        e.preventDefault()
        this.closeElement = window.document.getElementById(closers)
  ...
  private _update = () => {
    ...
    const bodyCanvasAttr = String(typeof window !== 'undefined' && window.document.body.getAttribute(`data-kt-drawer-${this.name}-`))
  ...
  private _hide = () => {
    ...
    this.shown = false
    this._deleteOverlay()
    typeof window !== 'undefined' && window.document.body.removeAttribute(`data-kt-drawer-${this.name}`)
    typeof window !== 'undefined' && window.document.body.removeAttribute(`data-kt-drawer`)
  ...
  private _show = () => {
    ...
    this.shown = true
    this._createOverlay()
    typeof window !== 'undefined' && window.document.body.setAttribute(`data-kt-drawer-${this.name}`, 'on')
    typeof window !== 'undefined' && window.document.body.setAttribute('data-kt-drawer', 'on')
  ...
  private _createOverlay = () => {
    if (this._getOption('overlay') === true && typeof window !== 'undefined') {
      ...
      window.document.body.append(this.overlayElement)
  ...
  public static createInstances(selector: string): void {
    if (typeof window !== 'undefined') {
      const elements = window.document.body.querySelectorAll(selector)
  ...
  public static handleDismiss = () => {
    ...
    if (typeof window !== 'undefined') {
      DOMEventHandlerUtil.on(window.document.body, '[data-kt-drawer-dismiss="true"]', 'click', () => {
        /* @ts-ignore */
      ...
      window.addEventListener('resize', function () {
        ...
        throttle(
          ...
          () => {
            ...
            const elements = window.document.body.querySelectorAll('[data-kt-drawer="true"]')
            elements.forEach((el) => {
