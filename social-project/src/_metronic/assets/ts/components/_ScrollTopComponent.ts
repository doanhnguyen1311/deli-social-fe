...
class ScrollTopComponent {
  ...
  private _scroll = () => {
    ...
    if (typeof window !== 'undefined') {
      if (pos > offset) {
        if (!window.document.body.hasAttribute('data-kt-scrolltop')) {
          window.document.body.setAttribute('data-kt-scrolltop', 'on')
        }
      } else {
        if (window.document.body.hasAttribute('data-kt-scrolltop')) {
          window.document.body.removeAttribute('data-kt-scrolltop')
        }
      }
    }
  }
