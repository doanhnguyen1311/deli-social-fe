...
class ToggleComponent {
  ...
  constructor(_element: HTMLElement, options: ToggleOptions) {
    ...
    if (elementTargetAttr && typeof window !== 'undefined') {
      this.target = window.document.querySelector(elementTargetAttr)
    }
  ...
  public static createInstances = (selector: string) => {
    if (typeof window !== 'undefined') {
      const elements = window.document.body.querySelectorAll<HTMLElement>(selector)
      elements.forEach((el) => {
