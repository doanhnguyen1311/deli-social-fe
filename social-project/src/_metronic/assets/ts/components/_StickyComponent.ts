...
class StickyComponent {
  ...
  private scroll = () => {
    ...
    if (reverse === true) {
      if (typeof window !== 'undefined') {
        ...
        if (st > offsetNum && this.lastScrollTop < st) {
          if (window.document.body.hasAttribute(this.attributeName) === false) {
            this.enable()
            window.document.body.setAttribute(this.attributeName, 'on')
            window.document.body.setAttribute(this.attributeName2, 'on')
          }
          ...
          // Back scroll mode
          if (window.document.body.hasAttribute(this.attributeName)) {
            this.disable()
            window.document.body.removeAttribute(this.attributeName)
            window.document.body.removeAttribute(this.attributeName2)
          }
    ...
    if (typeof window !== 'undefined') {
      if (st > offsetNum) {
        ...
        // back scroll mode
        if (window.document.body.hasAttribute(this.attributeName) === true) {
          this.disable()
          window.document.body.removeAttribute(this.attributeName)
          window.document.body.removeAttribute(this.attributeName2)
        }
  ...
  private enable = (update: boolean = false) => {
    ...
    if (width !== null && width !== undefined) {
      ...
      if (widthTarget && typeof window !== 'undefined') {
        const targetElement = window.document.querySelector(widthTarget)
        if (targetElement) {
