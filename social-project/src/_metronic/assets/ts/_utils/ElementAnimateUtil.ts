...
export class ElementAnimateUtil {
  ...
  public static scrollTo(element: HTMLElement | null, offset: number, duration: number = 500) {
    ...
    let scrollPos =
      window.pageYOffset || typeof window !== 'undefined' && window.document.documentElement.scrollTop || typeof window !== 'undefined' && window.document.body.scrollTop || 0
    ...
    ElementAnimateUtil.animate(from, to, duration, function (value: number) {
      if (typeof window !== 'undefined') window.document.documentElement.scrollTop = value
      // document.body.parentNode.scrollTop = value;
      if (typeof window !== 'undefined') window.document.body.scrollTop = value
    }) //, easing, done
  }
