...
import type { Bookmark, EditorEvent, HugeRTE, Editor as HugeRTEEditor } from 'hugerte';
...
export class Editor extends React.Component<IAllProps> {
  ...
  public constructor(props: Partial<IAllProps>) {
    ...
    this.elementRef = React.createRef<HTMLElement>() as React.RefObject<HTMLElement>;
