...
const ModalRenewOTP: FC<ModalStepContactProps> = ({
  otp,
  otpExpire,
  setOtpExpire,
  showModal,
  ...
  async function handleUpgradePlan() {
    try {
      ...
      await request.post("/package/renew-current-package", payload);
      swalToast.fire({
        icon: "success",
        title: "Renew service successfully!",
      });
      onRefreshData();
