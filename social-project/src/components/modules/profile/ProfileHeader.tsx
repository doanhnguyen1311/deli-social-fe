          ...
          <ul className='nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap'>
            <li className='nav-item'>
              <Link
                ...
                className={
                  ...
                  (pathname === '/crafted/pages/profile/overview' && 'active')
                }
            ...
            <li className='nav-item'>
              <Link
                ...
                className={
                  `nav-link text-active-primary me-6 ` +
                  (pathname === '/crafted/pages/profile/projects' && 'active')
                }
            ...
            <li className='nav-item'>
              <Link
                ...
                className={
                  `nav-link text-active-primary me-6 ` +
                  (pathname === '/crafted/pages/profile/campaigns' && 'active')
                }
            ...
            <li className='nav-item'>
              <Link
                ...
                className={
                  `nav-link text-active-primary me-6 ` +
                  (pathname === '/crafted/pages/profile/documents' && 'active')
                }
            ...
            <li className='nav-item'>
              <Link
                ...
                className={
                  `nav-link text-active-primary me-6 ` +
                  (pathname === '/crafted/pages/profile/connections' && 'active')
                }
